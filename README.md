...
| `USAGE_WARN_PCT` | `90` | the used % at or above which `session --hook` injects its usage line and ⚠ advisory and `session --rewake-waiter` arms; a whole number (anything else exits 2), and above 100 turns the hook's output off entirely |
