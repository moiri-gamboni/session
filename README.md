...
| `SESSION_SWITCH_NOTIFY` | unset | an executable run with one argument — the message — when the box switches login by itself, and when a blank credential is refused. Empty sends nothing |
